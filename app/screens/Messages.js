...
import Mess from '../components/active-icons/Mess';
        ...
        <View style={styles.container}>
            <View style={styles.con}>
                <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Logo />
                    <Text style={{ color: '#fff', fontSize: 32, fontWeight: '400', textAlign: 'center', marginBottom: 6, fontFamily: 'coolvetica' }}>Messages</Text>
                    <Search />
                </View>
